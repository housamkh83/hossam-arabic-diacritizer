...
import { B as Block, S as Static, g as BlockLabel, V as Code$2, i as Empty, k as IconButton, A as Copy$1, D as DownloadLink, n as Download$1, j as IconButtonWrapper, W as getWorkerProxyContext } from './2-BF-YoEic.js';
...
const lang_map = {
  python: () => import('./index32-CAsuDl5W.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-CGZ03QxN.js'),
      import('./frontmatter-KK7mzT14.js')
    ]);
  ...
  json: () => import('./index37-pmFfcPxS.js').then((m) => m.json()),
  html: () => import('./index34-I-1LCeHt.js').then((m) => m.html()),
  css: () => import('./index35-DAYNgYVj.js').then((m) => m.css()),
  javascript: () => import('./index36-coa_oPZw.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-coa_oPZw.js').then(
...
//# sourceMappingURL=Index15-LKoOOcG2.js.map
