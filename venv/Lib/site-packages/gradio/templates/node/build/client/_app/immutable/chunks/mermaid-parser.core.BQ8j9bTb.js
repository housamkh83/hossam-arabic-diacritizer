...
import { b1 as createAssigner, b2 as isPrototype, av as isArrayLike, aN as copyObject, az as assignValue, aw as isArray, a9 as baseRest, aa as isArrayLikeObject, aD as baseAssignValue, aG as isObjectLike, aH as baseGetTag, aS as nodeUtil, aE as baseUnary, ac as isFunction, ad as isEmpty, ax as identity, ar as isObject } from "./mermaid.core.C7OQ_Gio.js";
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from "./_baseUniq.BvXm3Wp1.js";
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, i as defaults, h as has, l as last, e as min } from "./_basePickBy.DiTuknNd.js";
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(() => import("./info-46DW6VJ7.B7XNh9x5.js"), true ? [] : void 0, import.meta.url);
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(() => import("./packet-W2GHVCYJ.isElclVg.js"), true ? [] : void 0, import.meta.url);
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(() => import("./pie-BEWT4RHE.9_QxdW9A.js"), true ? [] : void 0, import.meta.url);
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(() => import("./architecture-I3QFYML2.-H1ogrEx.js"), true ? [] : void 0, import.meta.url);
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(() => import("./gitGraph-YCYPL57B.BNlqxx0n.js"), true ? [] : void 0, import.meta.url);
